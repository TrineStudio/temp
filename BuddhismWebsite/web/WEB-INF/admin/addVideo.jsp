        ...
        <script type="text/javascript">
            $(function(){
                $("#fileupload").uploadify({
                    ...
                    'uploader'       : '<%=path%>/upload.action?admin=<%= ((Administrator)session.getAttribute("User")).getId() %>&&mediaType=1', 
                    ...
                    'fileSizeLimit'  : '100MB', //设置单个文件大小限制5m 
                    'queueSizeLimit' : 5, //队列中同时存在的文件个数限制 
                    'fileTypeDesc'       : '支持格式:avi/mp4/mpeg/wmv/mov.', //如果配置了以下的'fileExt'属性，那么这个属性是必须的 
                    'fileTypeExt'        : '*.avi;*.mp4;*.mpeg;*.wmv;*.mov',//允许的格式   
...
//                        $("#photolist").after("<img src='"+filepath+"' width=\"200px\"/>");
    ...
    <div id="rightside">
        ...
        <div class="contentbox">
            视频集:<s:select list="catList" name="packetId" listKey="catId" listValue="catName" id="type" emptyOption="false" />
