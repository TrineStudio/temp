        ...
        <div class="headings">
         ...
         <div class="contentbox">
             <form action="getPhotoByType">
                ...
                <a href="newAlbum.action?type=0" style="color: white;text-decoration: none" class="btn">添加相册</a>
             </form>
                <s:if test="packetId!=0">
                    <form action="updatePhotoAlubmDesc.action">
                        <p>
                            <label for="textfield"><strong></strong></label>
                            <strong>&nbsp;&nbsp;&nbsp;描述:&nbsp;</strong><textarea type="text"  id="textfield" name="packetDescription" class="inputbox" style="height:50px;"><s:property value="packetDescription"/></textarea> 
                        </p>
