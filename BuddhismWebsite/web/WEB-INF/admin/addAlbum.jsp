...
<body id="homepage">
    ...
    <div id="rightside">
        ...
        <div class="contentbox">
            <form action="addAlbum.action" method="post">
                <p>		
                    <label for="textfield"><strong><s:property value="pageTitle"/>标题</strong></label>
                    <input type="text" name="title" id="textfield" class="inputbox" style="width: 580px;"/>                     
                </p>
                <p>		
                    <label for="textfield"><strong><s:property value="pageTitle"/>描述</strong></label>
